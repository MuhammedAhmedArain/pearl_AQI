...
from src.feature_engineering import add_all_features  # noqa: E402
...
def generate_historical_data(
    ...
    hour_of_day = t.hour
    daily_cycle = 20 * np.sin(2 * np.pi * (hour_of_day - 14) / 24)  # peaks ~2PM
    ...
    temp = (
        20
        + 10 * np.sin(2 * np.pi * (hour_of_day - 14) / 24)
